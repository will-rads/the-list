...
3. `docs/agent/context.md` — product, business model, founders, where things will live
...
- After each piece of work, write the decision into `docs/agent/memory.md` (newest on top, `YYYY-MM-DD` dated).
- If you discover something that would have saved a previous chat time, write it into `docs/agent/errors.md`.
